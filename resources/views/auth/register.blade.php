    ...
    <img src="{{ url('ACT.png') }}" />
            ...
            <form method="POST" action="{{ url('/register') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-jet-input id="fullname" class="block mt-1 w-full" type="text" name="fullname" :value="old('fullname')" required autofocus autocomplete="fullname" placceholder="Your surname first" />
                </div>
